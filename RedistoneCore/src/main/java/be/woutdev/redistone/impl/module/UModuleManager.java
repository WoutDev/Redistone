package be.woutdev.redistone.impl.module;

import be.woutdev.redistone.api.config.Config;
import be.woutdev.redistone.api.module.ModuleLoadException;
import be.woutdev.redistone.api.module.ModuleManager;
import be.woutdev.redistone.api.module.PluginModule;
...
import be.woutdev.redistone.util.FileUtil;
...
public class UModuleManager implements ModuleManager
{
    ...
    private PluginModule loadModule(Path path) throws ModuleLoadException
    {
        try
        {
            ...
            {
                throw new ModuleLoadException(
                        "Failed to call empty constructor of module " + name + " version " + version + " at path " +
                        main + "!");
            }
